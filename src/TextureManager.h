...
public:
	...
	void drawButton(std::string id, int x, int y, int w, int h, bool selected, SDL_Renderer* pRenderer, SDL_RendererFlip flip = SDL_FLIP_NONE);
	void animate(std::string id, int x, int y, int w, int h, int maxFrames, int frame, SDL_Renderer* pRenderer, SDL_RendererFlip flip = SDL_FLIP_NONE);
